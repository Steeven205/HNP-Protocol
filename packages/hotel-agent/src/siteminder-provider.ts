...
import { computeYield, type YieldConfig, type CorporateDiscount, type YieldContext } from "./yield-engine.js";
...
export class SiteMinderProvider implements HotelDataProvider {
