    ...
    <>
      ...
      <header className="h-20 border-b border-white/10 glass-panel flex items-center justify-between px-6 flex-shrink-0">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5">Manage your plan and invoices</p>
        </div>
      ...
      <main className="flex-1 overflow-y-auto p-6 space-y-6">
        {/* Current Plan Card */}
        <div className="glass-panel rounded-2xl p-6 border border-emerald/20 animate-fade-up">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h2 className="font-display text-xl font-bold text-white">{billing.plan} Plan</h2>
          ...
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={f.label} className="bg-white/5 rounded-lg p-3">
                ...
                <p className="text-sm text-white font-medium mt-0.5">{f.value}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="glass-card rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs text-slate-400">Negotiations</span>
              </div>
